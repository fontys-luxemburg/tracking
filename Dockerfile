...
--restype javax.sql.ConnectionPoolDataSource --property user=Luxemburg-tracking:password=:Luxemburg-tracking=fin_dev:ServerName=postgresql:port=5432 fing-pool' > mycommands.asadmin &&
